      ...
      function_declarations: [
        {
          ...
          description:
            'Diagnose plant issues and provide brief explanations, treatment and prevention tips. Include programmer humor.',
          parameters: {
            type: 'object',
            properties: {
              plant: {
              ...
              primaryConfidence: {
                ...
                description:
                  'Confidence level in the primary diagnosis. Rate your confidence in your diagnosis realistically given the available information.',
              },
              primaryReasoning: {
                type: 'string',
                description:
              ...
              primarySummary: {
                type: 'string',
                description:
                  'Summary of the reasoning, treatment plan, and prevention tips for the primary diagnosis, in Markdown. Maximum 3-4 bullet points. Including programming humor.',
              },
              secondaryDiagnosis: {
                type: 'string',
                description:
              ...
              secondarySummary: {
                type: 'string',
                description:
                  'Summary of the reasoning, treatment plan, and prevention tips for the secondary diagnosis, in Markdown. Maximum 3-4 bullet points. Including programming humor.',
              },
              careTips: {
                type: 'string',
                description:
                  "Provide general care tips and best practices specific for the user's plant and the plant's situation as seen on the pictures, such as optimal light conditions, optimal soil type, watering schedule, fertilizer use, etc., in Markdown. Maximum 5-10 bullet points. Including programming humor.",
              },
            },
            required: [
              'plant',
      ...
      function_declarations: [
        {
          ...
          description:
            'Generate 3-5 short yes/no questions to help narrow down a plant diagnosis.',
          parameters: {
            type: 'object',
            properties: {
              Q1: {
