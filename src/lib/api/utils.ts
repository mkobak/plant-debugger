      ...
      function_declarations: [
            {
              ...
              parameters: {
                ...
                properties: {
                  ...
                  primarySummary: { type: "string", description: "Summary of the reasoning, treatment plan, and prevention tips for the primary diagnosis, in Markdown. Maximum 3-4 bullet points." },
                  ...
                  secondarySummary: { type: "string", description: "Summary of the reasoning, treatment plan, and prevention tips for the secondary diagnosis, in Markdown. Maximum 3-4 bullet points." },
                  careTips: { type: "string", description: "Provide general care tips and best practices specific for the user's plant and the plant's situation as seen on the pictures, such as optimal light conditions, optimal soil type, watering schedule, fertilizer use, etc., in Markdown. Maximum 5-10 bullet points." }
                },
